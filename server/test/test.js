...
<<<<<<< HEAD
    it('Should not Login without credentials', function(done) {
        request.post('http://localhost:3001/user/signin', function(err,res) {
=======
...
>>>>>>> f2277b860c6019c0db3bcfbb308b6b2dce2bdcb6
    ...
    it('Should not logout without Login', function(done) {
        request.post('http://localhost:3001/user/signout', function(error, response, body) {
    ...
    it('Should change the user image successfully, if the user is logged in', function(done) {
        request.post('http://localhost:3001/movietheatres/getMoviesInSearchPage', function(err,res) {
           // console.log(res.statusCode);
            assert.equal(402, res.statusCode);
            done();
        })
    });

<<<<<<< HEAD
    it('Should not get Basic Info without login', function(done) {
        request.post('http://localhost:3001/user/basicInfo', function(error, response, body) {
=======
